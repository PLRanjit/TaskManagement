      ...
      <div class="modal-body">
		 ...
		 <div class="form-group">
            <div class="row-fluid">
               <div  class="span6">
                  Task realtion :
                  <select id="taskrel" name="taskrel" style="width: 150px;">
					<option value="sales">Sales</option>
					<option value="support" >Support</option>
				 </select>
               </div>
               <div  class="span6">
                  Part Of which Service :
                  <input class="form-control" id="service" name="service" type="text" placeholder="Part of which Product service which vertical or divison" required>
               </div>
            </div>
         </div>
