<?php
			...
			$power = clean($_POST['power']);
				...
				$query=mysqli_query($con ,"UPDATE staff set power='$power',fullname='$fullname',employment_id='$employment_id',dob='$dob',doj='$doj',email='$email',contactno='$contactno',address='$address',position='$position',status='$status',username='$username',password='$password',project='$project' where staffid=$staffid") or die(mysqli_error());
