...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.php">Task Mgmt Employee</a></h1>
</div>
<!--close-Header-part--> 
    ...
    <div class="container-fluid">
		...
		<div class="quick-actions_homepage">
		  <ul class="quick-actions">
			<li class="bg_lb span6" > <a href="dashboard.php"> <i class="icon-dashboard"></i> My Dashboard </a> </li>
			<li class="bg_lg span6"> <a href="TaskManagement.php"> <i class="icon-th-list"></i> Task assigned by You and asigned to you</a> </li>
		  </ul>
		</div>
			  ...
			  <div class="widget-box">
				...
				<div class="widget-content" >
				  <div class="row-fluid">
					...
					<?php 
					$pending=mysqli_query($con ,"SELECT * FROM task WHERE status='In Progress'")or die(mysqli_error());
