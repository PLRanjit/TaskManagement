      ...
      <div class="modal-body">
         ...
         <div class="form-group">
            <div class="row-fluid">
               ...
               <div  class="span6">
                  Scheduled For :
                     <select multiple id="scheduled_for" name="scheduled_for" required>
            ...
            <div class="row-fluid">
               <div  class="span6">
					<?php 
							...
							$query=mysql_query("select * from staff where staffid = $id1 and status = 'Active'")or die(mysql_error());
