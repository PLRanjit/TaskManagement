...
/* 			$_dbHost = "localhost";
	...
	$query=mysqli_query($con ,"INSERT INTO staff (fullname,employment_id,dob,doj,email,contactno,address,position,status,username,password) VALUES ('$fullname','$employment_id','$dob','$doj','$email','$notel','$address','$position','Active','$username','$password')");	
	  if($query){	
